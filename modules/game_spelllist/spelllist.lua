...
function init()
  ...
  vocationBoxAssassino     = spelllistWindow:getChildById('vocationBoxAssassino')
  ...
  vocationRadioGroup:addWidget(vocationBoxAssassino)
...
function toggleFilter(widget, selectedWidget)
  if widget == vocationRadioGroup then
    ...
    elseif boxId == 'vocationBoxAssassino' then
      filters.vocationId = FILTER_VOCATION_ASSASSINO
    end
