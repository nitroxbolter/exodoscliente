...
function init()
  ...
  actionBar = gameRootPanel:getChildById('actionBar')
  health = gameRootPanel:getChildById('healthPanel')
  mana = gameRootPanel:getChildById('manaPanel')
  separator = gameRootPanel:getChildById('separatorAction')
  actionScroll = gameRootPanel:getChildById('scrollbarActionBar')
  left = gameRootPanel:getChildById('leftAction')
  right = gameRootPanel:getChildById('rightAction')
  action_exp = gameRootPanel:getChildById('powerBar')
  action_power = gameRootPanel:getChildById('expBar')
  hideChatButton = gameRootPanel:getChildById('hideChat')
  ...
  gameMapPanel:setFloorFading(250)
...
function hideChat()
  modules.game_console.hideChat(false, true)
end

function setKeyPressed(value)
  settings.keyPressed = value
end

function isKeyPressed()
  return settings.keyPressed or false
end

function togleActions(condition)
  health:setVisible(condition)
  mana:setVisible(condition)
  actionScroll:setVisible(condition)
  left:setVisible(condition)
  right:setVisible(condition)
  action_exp:setVisible(condition)
  action_power:setVisible(condition)
end
...
function updateStretchShrink()
  ...
  if modules.game_actionbar then
    modules.game_healthinfo.updateActionBars()
  end
end
